...
if __name__ == "__main__":
    ...
    p.add_argument("--merchant_category", type=str, required=True, choices=["grocery","ecommerce","fuel","travel","electronics","restaurant"])
    p.add_argument("--channel", type=str, required=True, choices=["pos","web","mobile","atm"])
    p.add_argument("--country", type=str, required=True, choices=["CA","US","MX","GB","FR","IN"])
